...
Durante a Sprint 0, comecei pelo estudo do Tainacan com base na documentação oficial e na exploração do repositório. Esse processo foi essencial para entender que o sistema opera como um plugin do WordPress e que grande parte de sua lógica está atrelada à estrutura desse ecossistema.
Na sequência, preparei o ambiente local com a instalação das dependências necessárias e, em seguida, explorei a interface e as principais funcionalidades da ferramenta para compreender como o Tainacan organiza coleções, itens e metadados.

---

## Principais Resultados

Ao final da sprint, o time alcançou resultados importantes para a continuidade do projeto: o ambiente local foi configurado e está funcional; a arquitetura do Tainacan foi compreendida em nível inicial; as tecnologias centrais do projeto foram assimiladas; o fluxo de uso do sistema foi mapeado; e a base documental foi organizada para apoiar a equipe.

---

## Dificuldades Encontradas

A maior dificuldade foi me adaptar ao WordPress, já que o Tainacan depende bastante de como essa plataforma funciona internamente. Fora isso, configurar o ambiente local também deu trabalho, especialmente por causa de dependências e ajustes que precisavam ser feitos para o sistema rodar direito.
...
|---|---|---|---|
| 1.0 | 08/06/2026 | Criação inicial do diário de bordo | Caio Pacheco |
